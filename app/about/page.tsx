    ...
    <main className="h-screen w-screen flex flex-col items-center justify-center overflow-hidden relative px-8">
      ...
      <div className="max-w-4xl mx-auto space-y-8 relative z-10">
        ...
        <div className="space-y-4 animate-fade-in text-center">
          ...
          <p className="text-lg text-slate/80 leading-relaxed max-w-2xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 pt-2">
          ...
          <div className="relative pl-4 border-l-2 border-teal flex-1">
            <div className="text-xs font-semibold text-teal tracking-widest uppercase mb-2">Griffin Arkilic</div>
          ...
          {/* Nicholas */}
          <div className="relative pl-4 border-l-2 border-teal flex-1">
            <div className="text-xs font-semibold text-teal tracking-widest uppercase mb-2">Nicholas Free</div>
            <p className="text-base text-slate/70 leading-relaxed">
        ...
        <div className="flex justify-between items-center pt-4 animate-fade-in">
          ...
          <a
            ...
            className="text-sm text-navy underline hover:text-teal transition-colors"
          >
            let&apos;s talk
          </a>
        </div>
