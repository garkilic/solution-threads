    ...
    <main className="workflow-theme min-h-screen w-screen flex flex-col items-center justify-center relative px-4 sm:px-8 py-12 sm:py-0">
      ...
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8 relative z-10">
        ...
        <div className="space-y-3 sm:space-y-4 animate-fade-in text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-zinc-100 leading-tight">
            Who we are.
          </h1>
        ...
        <div className="flex flex-col md:flex-row gap-6 sm:gap-8 md:gap-12 pt-2">
          {/* Griffin */}
          <div className="relative pl-4 border-l-2 border-emerald-500 flex-1">
            <div className="text-xs font-semibold text-emerald-400 tracking-widest uppercase mb-1 sm:mb-2">Griffin Arkilic</div>
          ...
          {/* Nicholas */}
          <div className="relative pl-4 border-l-2 border-emerald-500 flex-1">
            <div className="text-xs font-semibold text-emerald-400 tracking-widest uppercase mb-1 sm:mb-2">Nicholas Free</div>
            <p className="text-sm sm:text-base text-zinc-400 leading-relaxed">
        ...
        <div className="flex justify-between items-center pt-3 sm:pt-4 animate-fade-in">
          ...
          <a
            ...
            className="text-xs sm:text-sm text-zinc-200 underline hover:text-emerald-400 transition-colors"
          >
            let&apos;s talk
          </a>
        </div>
